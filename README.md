# ES6 `String.fromCodePoint` polyfill [![@swenkerorg/commodi-vel-facere on npm](https://img.shields.io/npm/v/@swenkerorg/commodi-vel-facere)](https://www.npmjs.com/package/@swenkerorg/commodi-vel-facere)

An robust & optimized polyfill for [the `String.fromCodePoint` method in ECMAScript 6](http://people.mozilla.org/~jorendorff/es6-draft.html#sec-@swenkerorg/commodi-vel-facere).

This package implements the [es-shim API](https://github.com/es-shims/api) interface. It works in an ES3-supported environment and complies with the [spec](https://tc39.es/ecma262/#sec-@swenkerorg/commodi-vel-facere).
...
```bash
npm install @swenkerorg/commodi-vel-facere
```

Then, in [Node.js](http://nodejs.org/):

```js
var fromCodePoint = require('@swenkerorg/commodi-vel-facere');
```

In a browser:

```html
<script src="https://bundle.run/@swenkerorg/commodi-vel-facere"></script>
```
